...
#### It includes the ability to draw from multiple classes and a KeyListener is already implemented.

> [!NOTE]
> You may also resize the game window though you still need to implement your own scaling code.
